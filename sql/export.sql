...
SELECT c.*,
       ...
       if(l3.land IN ("Sachsen", "Brandenburg", "Thüringen", "Sachsen-Anhalt", "Berlin", "Mecklenburg-Vorpommern"), 1,
          0)                                                                         as isOsten,


       # <editor-fold desc="isLand">
       if(land = "Baden-Württemberg", 1, 0)                                          as isBadenWuerttemberg,
       ...
       if(land = "Thüringen", 1, 0)                                                  as isThueringen,
       # </editor-fold>
